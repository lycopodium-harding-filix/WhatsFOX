...
if (Config.WORKTYPE == 'private') {
    ...
    Fox.addCommand({pattern: 'fox ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Fox.addCommand({pattern: 'fox ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
